...
class PersonService:
  ...
  def update(self,model_id:int):
    ...
    return self.form_data_crud.update(view_name="person/form",model_id=model_id,update_form=form,redirect_url=url_for("person_contorller.list"),params=params)
  
  def details(self,model_id:int):
    form = PersonDetailsForm()
    return self.form_data_crud.details("person/details",model_id=model_id,redirect_url=url_for("person_controller.list"),display_form=form)
  
  def detele(self,model_id:int):
